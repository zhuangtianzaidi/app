            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="paita(spuSaleAttr, spuSaleAttrValue)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  class="itxt"
                  v-model="quantity"
                  @keydown.enter="modify(quantity)"
                />
                <a href="javascript:" class="plus" @click="quantity++">+</a>
                <a
                  href="javascript:"
                  class="mins"
...
export default {
  ...
  //排他思想
  methods: {
    paita(spuSaleAttr, spuSaleAttrValue) {
      spuSaleAttr.spuSaleAttrValueList.forEach((spuSaleAttrValueList) => {
        spuSaleAttrValueList.isChecked = 0;
      });
